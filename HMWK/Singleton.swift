...
//    var betResponse: Response
    ...
    public override init()
    {
        ...
        teacherUser1 = User(aUsername: "mr_lewis", userEmail: "l@g.com", aProfileImage: #imageLiteral(resourceName: "profileimage"), aUserType: "teacherUser", aEnrolledCourses: [])


//        studentUser1 = User(aUsername: "jdogg219", userEmail: "lewis@gmail.com",aProfileImage: #imageLiteral(resourceName: "feedback"), aUserType: "studentUser", aEnrolledCourses: [])
//
//
...
//
//
//        economicsCourse = Course(courseID: "001", aCourseImagePath: "", courseImage: #imageLiteral(resourceName: "econ"), courseName: "Economics", coursePrompts: [freeMarketsPrompt, scarcityPrompt, demandPrompt], teacherID: "mr_lewis")
//        apMicroCourse = Course(courseID: "002", aCourseImagePath: "", courseImage: #imageLiteral(resourceName: "apmicro"), courseName: "AP Micro", coursePrompts: [elasticityPrompt], teacherID: "mr_lewis")
//        spanishCourse = Course(courseID: "003", aCourseImagePath: "", courseImage: #imageLiteral(resourceName: "spanish"), courseName: "Spanish I", coursePrompts: [casaPrompt], teacherID: "mr_lewis")
//        english8Course = Course(courseID: "004", aCourseImagePath: "", courseImage: #imageLiteral(resourceName: "books"), courseName: "English 8", coursePrompts: [betPrompt], teacherID: "mr_lewis")
//
//
